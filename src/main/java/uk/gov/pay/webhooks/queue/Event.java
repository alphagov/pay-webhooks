...
public class Event {
    ...
    public Event(String sqsMessageId,
                 ...
                 String eventData,
                 boolean reprojectDomainObject) {
        this(null, sqsMessageId, serviceId, live, resourceExternalId, parentResourceExternalId, eventDate, eventType,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, sqsMessageId, serviceId, live, resourceExternalId, parentResourceExternalId, eventDate, eventType, eventData, reprojectDomainObject);
    }
}
